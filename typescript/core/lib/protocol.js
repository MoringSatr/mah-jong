...
$root.coreProto = function () {
    ...
    coreProto.Message = function () {
        ...
        Message.decode = function decode(reader, length) {
            ...
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.coreProto.Message();
        ...
        Message.fromObject = function fromObject(object) {
            if (object instanceof $root.coreProto.Message) return object;
    ...
    coreProto.IntMsg = function () {
        ...
        IntMsg.encode = function encode(message, writer) {
            if (!writer) writer = $Writer.create();
            if (message.value != null && message.hasOwnProperty("value")) writer.uint32( /* id 1, wireType 0 =*/8).int32(message.value);
            return writer;
        };
        ...
        IntMsg.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.coreProto.IntMsg();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        IntMsg.fromObject = function fromObject(object) {
            if (object instanceof $root.coreProto.IntMsg) return object;
    ...
    coreProto.LongMsg = function () {
        ...
        LongMsg.encode = function encode(message, writer) {
            if (!writer) writer = $Writer.create();
            if (message.value != null && message.hasOwnProperty("value")) writer.uint32( /* id 1, wireType 0 =*/8).int64(message.value);
            return writer;
        };
        ...
        LongMsg.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.coreProto.LongMsg();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        LongMsg.fromObject = function fromObject(object) {
            if (object instanceof $root.coreProto.LongMsg) return object;
    ...
    coreProto.DoubleMsg = function () {
        ...
        DoubleMsg.encode = function encode(message, writer) {
            if (!writer) writer = $Writer.create();
            if (message.value != null && message.hasOwnProperty("value")) writer.uint32( /* id 1, wireType 1 =*/9).double(message.value);
            return writer;
        };
        ...
        DoubleMsg.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.coreProto.DoubleMsg();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        DoubleMsg.fromObject = function fromObject(object) {
            if (object instanceof $root.coreProto.DoubleMsg) return object;
    ...
    coreProto.FloatMsg = function () {
        ...
        FloatMsg.encode = function encode(message, writer) {
            if (!writer) writer = $Writer.create();
            if (message.value != null && message.hasOwnProperty("value")) writer.uint32( /* id 1, wireType 5 =*/13).float(message.value);
            return writer;
        };
        ...
        FloatMsg.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.coreProto.FloatMsg();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        FloatMsg.fromObject = function fromObject(object) {
            if (object instanceof $root.coreProto.FloatMsg) return object;
    ...
    coreProto.StringMsg = function () {
        ...
        StringMsg.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.coreProto.StringMsg();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        StringMsg.fromObject = function fromObject(object) {
            if (object instanceof $root.coreProto.StringMsg) return object;
    ...
    coreProto.BooleanMsg = function () {
        ...
        BooleanMsg.encode = function encode(message, writer) {
            if (!writer) writer = $Writer.create();
            if (message.value != null && message.hasOwnProperty("value")) writer.uint32( /* id 1, wireType 0 =*/8).bool(message.value);
            return writer;
        };
        ...
        BooleanMsg.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.coreProto.BooleanMsg();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        BooleanMsg.fromObject = function fromObject(object) {
            if (object instanceof $root.coreProto.BooleanMsg) return object;
    ...
    coreProto.IntsMsg = function () {
        ...
        IntsMsg.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.coreProto.IntsMsg();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        IntsMsg.fromObject = function fromObject(object) {
            if (object instanceof $root.coreProto.IntsMsg) return object;
            var message = new $root.coreProto.IntsMsg();
            if (object.value) {
                if (!Array.isArray(object.value)) throw TypeError(".coreProto.IntsMsg.value: array expected");
                message.value = [];
    ...
    coreProto.LongsMsg = function () {
        ...
        LongsMsg.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.coreProto.LongsMsg();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        LongsMsg.verify = function verify(message) {
            ...
            if (message.value != null && message.hasOwnProperty("value")) {
                if (!Array.isArray(message.value)) return "value: array expected";
                for (var i = 0; i < message.value.length; ++i) {
                    if (!$util.isInteger(message.value[i]) && !(message.value[i] && $util.isInteger(message.value[i].low) && $util.isInteger(message.value[i].high))) return "value: integer|Long[] expected";
                }
            }
            return null;
        };
        ...
        LongsMsg.fromObject = function fromObject(object) {
            if (object instanceof $root.coreProto.LongsMsg) return object;
            var message = new $root.coreProto.LongsMsg();
            if (object.value) {
                if (!Array.isArray(object.value)) throw TypeError(".coreProto.LongsMsg.value: array expected");
                message.value = [];
                for (var i = 0; i < object.value.length; ++i) {
                    if ($util.Long) (message.value[i] = $util.Long.fromValue(object.value[i])).unsigned = false;else if (typeof object.value[i] === "string") message.value[i] = parseInt(object.value[i], 10);else if (typeof object.value[i] === "number") message.value[i] = object.value[i];else if (_typeof(object.value[i]) === "object") message.value[i] = new $util.LongBits(object.value[i].low >>> 0, object.value[i].high >>> 0).toNumber();
                }
            }
            return message;
        };
        ...
        LongsMsg.toObject = function toObject(message, options) {
            ...
            if (message.value && message.value.length) {
                object.value = [];
                for (var j = 0; j < message.value.length; ++j) {
                    if (typeof message.value[j] === "number") object.value[j] = options.longs === String ? String(message.value[j]) : message.value[j];else object.value[j] = options.longs === String ? $util.Long.prototype.toString.call(message.value[j]) : options.longs === Number ? new $util.LongBits(message.value[j].low >>> 0, message.value[j].high >>> 0).toNumber() : message.value[j];
                }
            }
            return object;
        };
    ...
    coreProto.StringsMsg = function () {
        ...
        StringsMsg.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.coreProto.StringsMsg();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        StringsMsg.fromObject = function fromObject(object) {
            if (object instanceof $root.coreProto.StringsMsg) return object;
            var message = new $root.coreProto.StringsMsg();
            if (object.value) {
                if (!Array.isArray(object.value)) throw TypeError(".coreProto.StringsMsg.value: array expected");
                message.value = [];
                for (var i = 0; i < object.value.length; ++i) {
    ...
    coreProto.DoublesMsg = function () {
        ...
        DoublesMsg.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.coreProto.DoublesMsg();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        DoublesMsg.fromObject = function fromObject(object) {
            if (object instanceof $root.coreProto.DoublesMsg) return object;
            var message = new $root.coreProto.DoublesMsg();
            if (object.value) {
                if (!Array.isArray(object.value)) throw TypeError(".coreProto.DoublesMsg.value: array expected");
                message.value = [];
                for (var i = 0; i < object.value.length; ++i) {
    ...
    coreProto.FloatsMsg = function () {
        ...
        FloatsMsg.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.coreProto.FloatsMsg();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        FloatsMsg.fromObject = function fromObject(object) {
            if (object instanceof $root.coreProto.FloatsMsg) return object;
            var message = new $root.coreProto.FloatsMsg();
            if (object.value) {
                if (!Array.isArray(object.value)) throw TypeError(".coreProto.FloatsMsg.value: array expected");
                message.value = [];
                for (var i = 0; i < object.value.length; ++i) {
                    message.value[i] = Number(object.value[i]);
                }
    ...
    coreProto.IntIntMapMsg = function () {
        ...
        IntIntMapMsg.encode = function encode(message, writer) {
            if (!writer) writer = $Writer.create();
            if (message.value != null && message.hasOwnProperty("value")) for (var keys = Object.keys(message.value), i = 0; i < keys.length; ++i) {
        ...
        IntIntMapMsg.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.coreProto.IntIntMapMsg(),
                key;
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
                        reader.skip().pos++;
                        if (message.value === $util.emptyObject) message.value = {};
                        key = reader.int32();
                        reader.pos++;
        ...
        IntIntMapMsg.verify = function verify(message) {
            if ((typeof message === "undefined" ? "undefined" : _typeof(message)) !== "object" || message === null) return "object expected";
            if (message.value != null && message.hasOwnProperty("value")) {
                if (!$util.isObject(message.value)) return "value: object expected";
                var key = Object.keys(message.value);
                for (var i = 0; i < key.length; ++i) {
                    if (!$util.key32Re.test(key[i])) return "value: integer key{k:int32} expected";
                    if (!$util.isInteger(message.value[key[i]])) return "value: integer{k:int32} expected";
                }
            }
            return null;
        };
        ...
        IntIntMapMsg.fromObject = function fromObject(object) {
            if (object instanceof $root.coreProto.IntIntMapMsg) return object;
            var message = new $root.coreProto.IntIntMapMsg();
            if (object.value) {
                if (_typeof(object.value) !== "object") throw TypeError(".coreProto.IntIntMapMsg.value: object expected");
                message.value = {};
        ...
        IntIntMapMsg.toObject = function toObject(message, options) {
            if (!options) options = {};
            var object = {};
            if (options.objects || options.defaults) object.value = {};
            var keys2;
    ...
    coreProto.IntLongMapMsg = function () {
        ...
        IntLongMapMsg.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.coreProto.IntLongMapMsg(),
                key;
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
        ...
        IntLongMapMsg.verify = function verify(message) {
            ...
            if (message.value != null && message.hasOwnProperty("value")) {
                ...
                for (var i = 0; i < key.length; ++i) {
                    if (!$util.key32Re.test(key[i])) return "value: integer key{k:int32} expected";
                    if (!$util.isInteger(message.value[key[i]]) && !(message.value[key[i]] && $util.isInteger(message.value[key[i]].low) && $util.isInteger(message.value[key[i]].high))) return "value: integer|Long{k:int32} expected";
                }
            }
            return null;
        };
        ...
        IntLongMapMsg.fromObject = function fromObject(object) {
            if (object instanceof $root.coreProto.IntLongMapMsg) return object;
            var message = new $root.coreProto.IntLongMapMsg();
            if (object.value) {
                if (_typeof(object.value) !== "object") throw TypeError(".coreProto.IntLongMapMsg.value: object expected");
                message.value = {};
                for (var keys = Object.keys(object.value), i = 0; i < keys.length; ++i) {
                    if ($util.Long) (message.value[keys[i]] = $util.Long.fromValue(object.value[keys[i]])).unsigned = false;else if (typeof object.value[keys[i]] === "string") message.value[keys[i]] = parseInt(object.value[keys[i]], 10);else if (typeof object.value[keys[i]] === "number") message.value[keys[i]] = object.value[keys[i]];else if (_typeof(object.value[keys[i]]) === "object") message.value[keys[i]] = new $util.LongBits(object.value[keys[i]].low >>> 0, object.value[keys[i]].high >>> 0).toNumber();
                }
            }
            return message;
        };
        ...
        IntLongMapMsg.toObject = function toObject(message, options) {
            ...
            if (message.value && (keys2 = Object.keys(message.value)).length) {
                object.value = {};
                for (var j = 0; j < keys2.length; ++j) {
                    if (typeof message.value[keys2[j]] === "number") object.value[keys2[j]] = options.longs === String ? String(message.value[keys2[j]]) : message.value[keys2[j]];else object.value[keys2[j]] = options.longs === String ? $util.Long.prototype.toString.call(message.value[keys2[j]]) : options.longs === Number ? new $util.LongBits(message.value[keys2[j]].low >>> 0, message.value[keys2[j]].high >>> 0).toNumber() : message.value[keys2[j]];
                }
            }
            return object;
        };
    ...
    coreProto.IntStringMapMsg = function () {
        ...
        IntStringMapMsg.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.coreProto.IntStringMapMsg(),
                key;
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
        ...
        IntStringMapMsg.verify = function verify(message) {
            ...
            if (message.value != null && message.hasOwnProperty("value")) {
                ...
                for (var i = 0; i < key.length; ++i) {
                    if (!$util.key32Re.test(key[i])) return "value: integer key{k:int32} expected";
                    if (!$util.isString(message.value[key[i]])) return "value: string{k:int32} expected";
                }
            }
            return null;
        };
        ...
        IntStringMapMsg.fromObject = function fromObject(object) {
            if (object instanceof $root.coreProto.IntStringMapMsg) return object;
            var message = new $root.coreProto.IntStringMapMsg();
            if (object.value) {
                if (_typeof(object.value) !== "object") throw TypeError(".coreProto.IntStringMapMsg.value: object expected");
                message.value = {};
                for (var keys = Object.keys(object.value), i = 0; i < keys.length; ++i) {
    ...
    coreProto.LongLongMapMsg = function () {
        ...
        LongLongMapMsg.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.coreProto.LongLongMapMsg(),
                key;
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
        ...
        LongLongMapMsg.verify = function verify(message) {
            ...
            if (message.value != null && message.hasOwnProperty("value")) {
                ...
                var key = Object.keys(message.value);
                for (var i = 0; i < key.length; ++i) {
                    if (!$util.key64Re.test(key[i])) return "value: integer|Long key{k:int64} expected";
                    if (!$util.isInteger(message.value[key[i]]) && !(message.value[key[i]] && $util.isInteger(message.value[key[i]].low) && $util.isInteger(message.value[key[i]].high))) return "value: integer|Long{k:int64} expected";
                }
            }
            return null;
        };
        ...
        LongLongMapMsg.fromObject = function fromObject(object) {
            if (object instanceof $root.coreProto.LongLongMapMsg) return object;
            var message = new $root.coreProto.LongLongMapMsg();
            if (object.value) {
                if (_typeof(object.value) !== "object") throw TypeError(".coreProto.LongLongMapMsg.value: object expected");
                message.value = {};
                for (var keys = Object.keys(object.value), i = 0; i < keys.length; ++i) {
                    if ($util.Long) (message.value[keys[i]] = $util.Long.fromValue(object.value[keys[i]])).unsigned = false;else if (typeof object.value[keys[i]] === "string") message.value[keys[i]] = parseInt(object.value[keys[i]], 10);else if (typeof object.value[keys[i]] === "number") message.value[keys[i]] = object.value[keys[i]];else if (_typeof(object.value[keys[i]]) === "object") message.value[keys[i]] = new $util.LongBits(object.value[keys[i]].low >>> 0, object.value[keys[i]].high >>> 0).toNumber();
                }
    ...
    coreProto.LongIntMapMsg = function () {
        ...
        LongIntMapMsg.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.coreProto.LongIntMapMsg(),
                key;
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
        ...
        LongIntMapMsg.verify = function verify(message) {
            ...
            if (message.value != null && message.hasOwnProperty("value")) {
                ...
                for (var i = 0; i < key.length; ++i) {
                    if (!$util.key64Re.test(key[i])) return "value: integer|Long key{k:int64} expected";
                    if (!$util.isInteger(message.value[key[i]])) return "value: integer{k:int64} expected";
                }
            }
            return null;
        };
        ...
        LongIntMapMsg.fromObject = function fromObject(object) {
            if (object instanceof $root.coreProto.LongIntMapMsg) return object;
            var message = new $root.coreProto.LongIntMapMsg();
            if (object.value) {
                if (_typeof(object.value) !== "object") throw TypeError(".coreProto.LongIntMapMsg.value: object expected");
                message.value = {};
                for (var keys = Object.keys(object.value), i = 0; i < keys.length; ++i) {
                    message.value[keys[i]] = object.value[keys[i]] | 0;
                }
    ...
    coreProto.LongStringMapMsg = function () {
        ...
        LongStringMapMsg.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.coreProto.LongStringMapMsg(),
                key;
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
        ...
        LongStringMapMsg.verify = function verify(message) {
            ...
            if (message.value != null && message.hasOwnProperty("value")) {
                ...
                for (var i = 0; i < key.length; ++i) {
                    if (!$util.key64Re.test(key[i])) return "value: integer|Long key{k:int64} expected";
                    if (!$util.isString(message.value[key[i]])) return "value: string{k:int64} expected";
                }
            }
            return null;
        };
        ...
        LongStringMapMsg.fromObject = function fromObject(object) {
            if (object instanceof $root.coreProto.LongStringMapMsg) return object;
            var message = new $root.coreProto.LongStringMapMsg();
            if (object.value) {
                if (_typeof(object.value) !== "object") throw TypeError(".coreProto.LongStringMapMsg.value: object expected");
                message.value = {};
                for (var keys = Object.keys(object.value), i = 0; i < keys.length; ++i) {
                    message.value[keys[i]] = String(object.value[keys[i]]);
                }
...
$root.playerProto = function () {
    ...
    playerProto.SimplePlayerMsg = function () {
        ...
        SimplePlayerMsg.encode = function encode(message, writer) {
            if (!writer) writer = $Writer.create();
            if (message.playerId != null && message.hasOwnProperty("playerId")) writer.uint32( /* id 1, wireType 0 =*/8).int64(message.playerId);
            if (message.nickname != null && message.hasOwnProperty("nickname")) writer.uint32( /* id 2, wireType 2 =*/18).string(message.nickname);
            if (message.headImage != null && message.hasOwnProperty("headImage")) writer.uint32( /* id 3, wireType 2 =*/26).string(message.headImage);
            if (message.state != null && message.hasOwnProperty("state")) writer.uint32( /* id 4, wireType 0 =*/32).int32(message.state);
            return writer;
        };
        ...
        SimplePlayerMsg.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.playerProto.SimplePlayerMsg();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        SimplePlayerMsg.verify = function verify(message) {
            if ((typeof message === "undefined" ? "undefined" : _typeof(message)) !== "object" || message === null) return "object expected";
            if (message.playerId != null && message.hasOwnProperty("playerId")) if (!$util.isInteger(message.playerId) && !(message.playerId && $util.isInteger(message.playerId.low) && $util.isInteger(message.playerId.high))) return "playerId: integer|Long expected";
            ...
            if (message.headImage != null && message.hasOwnProperty("headImage")) if (!$util.isString(message.headImage)) return "headImage: string expected";
        ...
        SimplePlayerMsg.fromObject = function fromObject(object) {
            if (object instanceof $root.playerProto.SimplePlayerMsg) return object;
            var message = new $root.playerProto.SimplePlayerMsg();
            if (object.playerId != null) if ($util.Long) (message.playerId = $util.Long.fromValue(object.playerId)).unsigned = false;else if (typeof object.playerId === "string") message.playerId = parseInt(object.playerId, 10);else if (typeof object.playerId === "number") message.playerId = object.playerId;else if (_typeof(object.playerId) === "object") message.playerId = new $util.LongBits(object.playerId.low >>> 0, object.playerId.high >>> 0).toNumber();
            if (object.nickname != null) message.nickname = String(object.nickname);
            if (object.headImage != null) message.headImage = String(object.headImage);
            switch (object.state) {
                case "ONLINE":
                case 0:
                    message.state = 0;
        ...
        SimplePlayerMsg.toObject = function toObject(message, options) {
            ...
            if (message.headImage != null && message.hasOwnProperty("headImage")) object.headImage = message.headImage;
            if (message.state != null && message.hasOwnProperty("state")) object.state = options.enums === String ? $root.playerProto.PlayerState[message.state] : message.state;
            return object;
        };
    ...
    playerProto.PlayerMsg = function () {
        ...
        PlayerMsg.encode = function encode(message, writer) {
            if (!writer) writer = $Writer.create();
            if (message.simplePlayer != null && message.hasOwnProperty("simplePlayer")) $root.playerProto.SimplePlayerMsg.encode(message.simplePlayer, writer.uint32( /* id 1, wireType 2 =*/10).fork()).ldelim();
            if (message.roomCardNum != null && message.hasOwnProperty("roomCardNum")) writer.uint32( /* id 2, wireType 0 =*/16).int32(message.roomCardNum);
            return writer;
        };
        ...
        PlayerMsg.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.playerProto.PlayerMsg();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        PlayerMsg.verify = function verify(message) {
            ...
            if (message.simplePlayer != null && message.hasOwnProperty("simplePlayer")) {
                ...
                if (error) return "simplePlayer." + error;
            }
            if (message.roomCardNum != null && message.hasOwnProperty("roomCardNum")) if (!$util.isInteger(message.roomCardNum)) return "roomCardNum: integer expected";
            return null;
        };
        ...
        PlayerMsg.fromObject = function fromObject(object) {
            if (object instanceof $root.playerProto.PlayerMsg) return object;
            var message = new $root.playerProto.PlayerMsg();
            if (object.simplePlayer != null) {
                if (_typeof(object.simplePlayer) !== "object") throw TypeError(".playerProto.PlayerMsg.simplePlayer: object expected");
                message.simplePlayer = $root.playerProto.SimplePlayerMsg.fromObject(object.simplePlayer);
            }
            if (object.roomCardNum != null) message.roomCardNum = object.roomCardNum | 0;
            return message;
        };
        ...
        PlayerMsg.toObject = function toObject(message, options) {
            ...
            if (message.simplePlayer != null && message.hasOwnProperty("simplePlayer")) object.simplePlayer = $root.playerProto.SimplePlayerMsg.toObject(message.simplePlayer, options);
            if (message.roomCardNum != null && message.hasOwnProperty("roomCardNum")) object.roomCardNum = message.roomCardNum;
            return object;
        };
...
$root.roomProto = function () {
    ...
    roomProto.RoomMsg = function () {
        ...
        RoomMsg.encode = function encode(message, writer) {
            if (!writer) writer = $Writer.create();
            if (message.roomId != null && message.hasOwnProperty("roomId")) writer.uint32( /* id 1, wireType 0 =*/8).int32(message.roomId);
            ...
            }if (message.gameType != null && message.hasOwnProperty("gameType")) writer.uint32( /* id 3, wireType 0 =*/24).int32(message.gameType);
            return writer;
        };
        ...
        RoomMsg.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.roomProto.RoomMsg();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        RoomMsg.verify = function verify(message) {
            ...
            if (message.gameType != null && message.hasOwnProperty("gameType")) switch (message.gameType) {
                default:
        ...
        RoomMsg.fromObject = function fromObject(object) {
            if (object instanceof $root.roomProto.RoomMsg) return object;
            var message = new $root.roomProto.RoomMsg();
            if (object.roomId != null) message.roomId = object.roomId | 0;
            if (object.players) {
                if (!Array.isArray(object.players)) throw TypeError(".roomProto.RoomMsg.players: array expected");
                message.players = [];
                for (var i = 0; i < object.players.length; ++i) {
                    if (_typeof(object.players[i]) !== "object") throw TypeError(".roomProto.RoomMsg.players: object expected");
        ...
        RoomMsg.toObject = function toObject(message, options) {
            if (!options) options = {};
            var object = {};
            if (options.arrays || options.defaults) object.players = [];
            if (options.defaults) {
                object.roomId = 0;
            ...
            if (message.gameType != null && message.hasOwnProperty("gameType")) object.gameType = options.enums === String ? $root.gameProto.GameType[message.gameType] : message.gameType;
            return object;
        };
    ...
    roomProto.RoomPlayer = function () {
        ...
        RoomPlayer.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.roomProto.RoomPlayer();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        RoomPlayer.fromObject = function fromObject(object) {
            if (object instanceof $root.roomProto.RoomPlayer) return object;
            var message = new $root.roomProto.RoomPlayer();
            if (object.simplePlayer != null) {
                if (_typeof(object.simplePlayer) !== "object") throw TypeError(".roomProto.RoomPlayer.simplePlayer: object expected");
                message.simplePlayer = $root.playerProto.SimplePlayerMsg.fromObject(object.simplePlayer);
            }
            return message;
        };
        ...
        RoomPlayer.toObject = function toObject(message, options) {
            if (!options) options = {};
            var object = {};
            if (options.defaults) object.simplePlayer = null;
            if (message.simplePlayer != null && message.hasOwnProperty("simplePlayer")) object.simplePlayer = $root.playerProto.SimplePlayerMsg.toObject(message.simplePlayer, options);
            return object;
        };
...
$root.settingsProto = function () {
    ...
    settingsProto.SettingsMsg = function () {
        ...
        SettingsMsg.encode = function encode(message, writer) {
            if (!writer) writer = $Writer.create();
            if (message.backgroundMusic != null && message.hasOwnProperty("backgroundMusic")) writer.uint32( /* id 1, wireType 0 =*/8).int32(message.backgroundMusic);
            if (message.soundEffect != null && message.hasOwnProperty("soundEffect")) writer.uint32( /* id 2, wireType 0 =*/16).int32(message.soundEffect);
            return writer;
        };
        ...
        SettingsMsg.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.settingsProto.SettingsMsg();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        SettingsMsg.verify = function verify(message) {
            if ((typeof message === "undefined" ? "undefined" : _typeof(message)) !== "object" || message === null) return "object expected";
            if (message.backgroundMusic != null && message.hasOwnProperty("backgroundMusic")) if (!$util.isInteger(message.backgroundMusic)) return "backgroundMusic: integer expected";
            if (message.soundEffect != null && message.hasOwnProperty("soundEffect")) if (!$util.isInteger(message.soundEffect)) return "soundEffect: integer expected";
            return null;
        };
        ...
        SettingsMsg.fromObject = function fromObject(object) {
            if (object instanceof $root.settingsProto.SettingsMsg) return object;
            var message = new $root.settingsProto.SettingsMsg();
            if (object.backgroundMusic != null) message.backgroundMusic = object.backgroundMusic | 0;
            if (object.soundEffect != null) message.soundEffect = object.soundEffect | 0;
            return message;
        };
        ...
        SettingsMsg.toObject = function toObject(message, options) {
            ...
            if (message.backgroundMusic != null && message.hasOwnProperty("backgroundMusic")) object.backgroundMusic = message.backgroundMusic;
            if (message.soundEffect != null && message.hasOwnProperty("soundEffect")) object.soundEffect = message.soundEffect;
            return object;
        };
...
$root.userProto = function () {
    ...
    userProto.UserMsg = function () {
        ...
        UserMsg.encode = function encode(message, writer) {
            if (!writer) writer = $Writer.create();
            if (message.userId != null && message.hasOwnProperty("userId")) writer.uint32( /* id 1, wireType 0 =*/8).int64(message.userId);
            if (message.name != null && message.hasOwnProperty("name")) writer.uint32( /* id 2, wireType 2 =*/18).string(message.name);
            if (message.headImage != null && message.hasOwnProperty("headImage")) writer.uint32( /* id 3, wireType 2 =*/26).string(message.headImage);
            if (message.gender != null && message.hasOwnProperty("gender")) writer.uint32( /* id 4, wireType 0 =*/32).int32(message.gender);
            return writer;
        };
        ...
        UserMsg.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length,
                message = new $root.userProto.UserMsg();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                    case 1:
        ...
        UserMsg.verify = function verify(message) {
            if ((typeof message === "undefined" ? "undefined" : _typeof(message)) !== "object" || message === null) return "object expected";
            if (message.userId != null && message.hasOwnProperty("userId")) if (!$util.isInteger(message.userId) && !(message.userId && $util.isInteger(message.userId.low) && $util.isInteger(message.userId.high))) return "userId: integer|Long expected";
        ...
        UserMsg.toObject = function toObject(message, options) {
            ...
            if (message.userId != null && message.hasOwnProperty("userId")) if (typeof message.userId === "number") object.userId = options.longs === String ? String(message.userId) : message.userId;else object.userId = options.longs === String ? $util.Long.prototype.toString.call(message.userId) : options.longs === Number ? new $util.LongBits(message.userId.low >>> 0, message.userId.high >>> 0).toNumber() : message.userId;
            if (message.name != null && message.hasOwnProperty("name")) object.name = message.name;
            if (message.headImage != null && message.hasOwnProperty("headImage")) object.headImage = message.headImage;
            if (message.gender != null && message.hasOwnProperty("gender")) object.gender = options.enums === String ? $root.userProto.Gender[message.gender] : message.gender;
            return object;
        };
